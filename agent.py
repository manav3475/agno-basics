...
agent = Agent(
    ...
    instructions=dedent("""
            ...
            3. Add key point only when asked for.
            4. The Summary created should include both advantages and disadvantages.
                        """),
...
agent.print_response("I need short answers on topic of Data Science in today's world, it's all most 100 words.")
